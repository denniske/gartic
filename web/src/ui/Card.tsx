...
export function Card(props: Props) {
    ...
    if (player) {
        return (
            <div
                className="rounded-l-[35px] rounded-r-xl bg-gray-300 border-2 border-gray-300 cursor-pointer flex items-center px-3 py-2 space-x-4">
                <div>
                ...
                <div
                    className="border-2 border-purple-800 rounded-full h-8 w-8 flex items-center justify-center hover:bg-purple-800 text-purple-800 hover:text-gray-300">
    ...
    return (
        <div
            className="rounded-l-[35px] rounded-r-xl bg-purple-700 border-2 border-purple-500 cursor-pointer flex items-center px-3 py-2 space-x-4">
            <div>
