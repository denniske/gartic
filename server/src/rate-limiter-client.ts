...
type GetLimiterCallback = () => DurableObjectStub;
type ReportErrorCallback = (err: any) => void;
...
export class RateLimiterClient {
    ...
    private getLimiterStub: GetLimiterCallback;
    private reportError: ReportErrorCallback;

    constructor(getLimiterStub: GetLimiterCallback, reportError: ReportErrorCallback) {
